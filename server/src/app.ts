...
import brainResetRoutes from './routes/brainResetRoutes';
...
import personalContactsRoutes from './routes/personalContactsRoutes';
...
import whatsappHealthRoutes from './routes/admin/whatsappHealthRoutes';
...
v1.use('/user/personal-contacts', personalContactsRoutes);
v1.use('/user/preferences', userPreferencesRoutes);
...
v1.use('/admin', whatsappHealthRoutes);
