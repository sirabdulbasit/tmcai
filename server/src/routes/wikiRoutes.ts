...
// archive/restore/delete moved to brainAskRoutes.ts (mounted at /brain/wiki/*)
// where the frontend actually hits them. wikiRoutes.ts is mounted at /wiki/*
// — agent-callable, not used by the dashboard UI.
